...
<head>
    ...
    <title>@yield('title','Dashboard') | ASEBA Admin</title>
...
<div class="app">
    ...
    <aside class="sidebar"
        ...
        <div class="sidebar-menu">
            ...
            class="menu-item {{ request()->routeIs('admin.aseba.profile') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.players.index') }}"
               class="menu-item {{ request()->routeIs('admin.players.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.teams.index') }}"
               class="menu-item {{ request()->routeIs('admin.teams.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.courts.bookings') }}"
               class="menu-item {{ request()->routeIs('admin.courts.bookings') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.courts.approval') }}"
               class="menu-item {{ request()->routeIs('admin.courts.approval') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.courts.history') }}"
               class="menu-item {{ request()->routeIs('admin.courts.history') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.courts.settings') }}"
               class="menu-item {{ request()->routeIs('admin.courts.settings') ? 'active' : '' }}">

                <i class="bi bi-sliders"></i>

                <span>Pengaturan Lapangan</span>
            ...
            <div class="topbar-left">
                ...
                <div class="page-info">
                    ...
                    <p class="page-subtitle">
                        ...
                        @yield('page-subtitle','Selamat datang kembali di ASEBA Admin Panel.')
