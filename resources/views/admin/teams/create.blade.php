...
@section('page-subtitle','Registrasi tim baru ASEBA')
            ...
            <div class="col-lg-4">
                ...
                <div class="form-card">
                    ...
                    <div class="team-logo">
                        ...
                        {{ strtoupper(substr(old('name','T'),0,1)) }}
                    ...
                    <small class="text-muted">
                        ...
                        Logo menggunakan huruf pertama nama tim secara otomatis.
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea
                                ...
                                placeholder="Masukkan deskripsi singkat mengenai tim...">{{ old('description') }}</textarea>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <small class="text-muted">
                                ...
                                Hanya pemain yang belum memiliki tim yang dapat dipilih.
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="search-player">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="Cari nama pemain, nomor punggung, atau posisi...">
                            ...
                            <table class="table align-middle team-table">
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        $disabled=!is_null($player->team_id);

                                    @endphp

                                    <tr

                                         class="player-row {{ $disabled ? 'table-secondary' : '' }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <div>
                            ...
                            <small class="text-muted">
                                ...
                                Tim akan langsung dibuat setelah disimpan.
